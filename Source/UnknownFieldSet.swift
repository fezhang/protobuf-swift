...
public class UnknownFieldSet:Hashable,Equatable
{
    ...
    {
        let sortedKeys = Array(fields.keys)
        sortedKeys.sorted { $0 < $1 }
    ...
    public class Builder
    {
        ...
        public func mergeFromInputStream(_ input:NSInputStream, extensionRegistry:ExtensionRegistry) throws -> UnknownFieldSet.Builder
        {
            throw ProtocolBuffersError.obvious("UnsupportedMethod")
        }
