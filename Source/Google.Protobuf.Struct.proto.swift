...
public extension Google.Protobuf {
  ...
  final public class Struct : GeneratedMessage, GeneratedMessageProtocol {
    ...
    //Nested type declaration start
      ...
      final public class FieldsEntry : GeneratedMessage, GeneratedMessageProtocol {
        ...
        public class func parseArrayDelimitedFromInputStream(_ input:NSInputStream) throws -> Array<Google.Protobuf.Struct.FieldsEntry> {
        ...
        public class func parseFromDelimitedFromInputStream(_ input:NSInputStream) throws -> Google.Protobuf.Struct.FieldsEntry? {
          return try Google.Protobuf.Struct.FieldsEntry.Builder().mergeDelimitedFromInputStream(input)?.build()
        }
        public class func parseFromData(_ data:NSData) throws -> Google.Protobuf.Struct.FieldsEntry {
        ...
        public class func parseFromData(_ data:NSData, extensionRegistry:ExtensionRegistry) throws -> Google.Protobuf.Struct.FieldsEntry {
          return try Google.Protobuf.Struct.FieldsEntry.Builder().mergeFromData(data, extensionRegistry:extensionRegistry).build()
        }
        public class func parseFromInputStream(_ input:NSInputStream) throws -> Google.Protobuf.Struct.FieldsEntry {
          return try Google.Protobuf.Struct.FieldsEntry.Builder().mergeFromInputStream(input).build()
        }
        public class func parseFromInputStream(_ input:NSInputStream, extensionRegistry:ExtensionRegistry) throws -> Google.Protobuf.Struct.FieldsEntry {
        ...
        override class public func fromJSON(_ data:NSData) throws -> Google.Protobuf.Struct.FieldsEntry {
        ...
        final public class Builder : GeneratedMessageBuilder {
          ...
          override class public func fromJSONToBuilder(_ data:NSData) throws -> Google.Protobuf.Struct.FieldsEntry.Builder {
    ...
    public class func parseArrayDelimitedFromInputStream(_ input:NSInputStream) throws -> Array<Google.Protobuf.Struct> {
    ...
    public class func parseFromDelimitedFromInputStream(_ input:NSInputStream) throws -> Google.Protobuf.Struct? {
      return try Google.Protobuf.Struct.Builder().mergeDelimitedFromInputStream(input)?.build()
    }
    public class func parseFromData(_ data:NSData) throws -> Google.Protobuf.Struct {
    ...
    public class func parseFromData(_ data:NSData, extensionRegistry:ExtensionRegistry) throws -> Google.Protobuf.Struct {
      return try Google.Protobuf.Struct.Builder().mergeFromData(data, extensionRegistry:extensionRegistry).build()
    }
    public class func parseFromInputStream(_ input:NSInputStream) throws -> Google.Protobuf.Struct {
      return try Google.Protobuf.Struct.Builder().mergeFromInputStream(input).build()
    }
    public class func parseFromInputStream(_ input:NSInputStream, extensionRegistry:ExtensionRegistry) throws -> Google.Protobuf.Struct {
    ...
    override class public func fromJSON(_ data:NSData) throws -> Google.Protobuf.Struct {
    ...
    final public class Builder : GeneratedMessageBuilder {
      ...
      override class public func fromJSONToBuilder(_ data:NSData) throws -> Google.Protobuf.Struct.Builder {
        let jsonData = try NSJSONSerialization.jsonObject(with: data, options: NSJSONReadingOptions(rawValue: 0))
        guard let jsDataCast = jsonData as? Dictionary<String,AnyObject> else {
          throw ProtocolBuffersError.invalidProtocolBuffer("Invalid JSON data")
        }
  ...
  final public class Value : GeneratedMessage, GeneratedMessageProtocol {
    ...
    public private(set) var hasNullValue:Bool {
          get {
                guard let _ = Kind.getNullValue(storageKind) else {
                    return false
                }
                return true
          }
    ...
    public private(set) var nullValue:Google.Protobuf.NullValue!{
         get {
              return Kind.getNullValue(storageKind)
         }
         set (newvalue) {
              storageKind = Kind.nullValue(newvalue)
         }
    }
    // Represents a double value.
    public private(set) var hasNumberValue:Bool {
          get {
                guard let _ = Kind.getNumberValue(storageKind) else {
                    return false
                }
                return true
          }
    ...
    public class func parseArrayDelimitedFromInputStream(_ input:NSInputStream) throws -> Array<Google.Protobuf.Value> {
    ...
    public class func parseFromDelimitedFromInputStream(_ input:NSInputStream) throws -> Google.Protobuf.Value? {
      return try Google.Protobuf.Value.Builder().mergeDelimitedFromInputStream(input)?.build()
    }
    public class func parseFromData(_ data:NSData) throws -> Google.Protobuf.Value {
    ...
    public class func parseFromData(_ data:NSData, extensionRegistry:ExtensionRegistry) throws -> Google.Protobuf.Value {
      return try Google.Protobuf.Value.Builder().mergeFromData(data, extensionRegistry:extensionRegistry).build()
    }
    public class func parseFromInputStream(_ input:NSInputStream) throws -> Google.Protobuf.Value {
      return try Google.Protobuf.Value.Builder().mergeFromInputStream(input).build()
    }
    public class func parseFromInputStream(_ input:NSInputStream, extensionRegistry:ExtensionRegistry) throws -> Google.Protobuf.Value {
    ...
    override class public func fromJSON(_ data:NSData) throws -> Google.Protobuf.Value {
    ...
    final public class Builder : GeneratedMessageBuilder {
      ...
      override class public func fromJSONToBuilder(_ data:NSData) throws -> Google.Protobuf.Value.Builder {
        let jsonData = try NSJSONSerialization.jsonObject(with: data, options: NSJSONReadingOptions(rawValue: 0))
        guard let jsDataCast = jsonData as? Dictionary<String,AnyObject> else {
          throw ProtocolBuffersError.invalidProtocolBuffer("Invalid JSON data")
        }
  ...
  final public class ListValue : GeneratedMessage, GeneratedMessageProtocol {
    ...
    public class func parseArrayDelimitedFromInputStream(_ input:NSInputStream) throws -> Array<Google.Protobuf.ListValue> {
    ...
    public class func parseFromDelimitedFromInputStream(_ input:NSInputStream) throws -> Google.Protobuf.ListValue? {
      return try Google.Protobuf.ListValue.Builder().mergeDelimitedFromInputStream(input)?.build()
    }
    public class func parseFromData(_ data:NSData) throws -> Google.Protobuf.ListValue {
    ...
    public class func parseFromData(_ data:NSData, extensionRegistry:ExtensionRegistry) throws -> Google.Protobuf.ListValue {
      return try Google.Protobuf.ListValue.Builder().mergeFromData(data, extensionRegistry:extensionRegistry).build()
    }
    public class func parseFromInputStream(_ input:NSInputStream) throws -> Google.Protobuf.ListValue {
      return try Google.Protobuf.ListValue.Builder().mergeFromInputStream(input).build()
    }
    public class func parseFromInputStream(_ input:NSInputStream, extensionRegistry:ExtensionRegistry) throws -> Google.Protobuf.ListValue {
    ...
    override class public func fromJSON(_ data:NSData) throws -> Google.Protobuf.ListValue {
    ...
    final public class Builder : GeneratedMessageBuilder {
      ...
      override class public func fromJSONToBuilder(_ data:NSData) throws -> Google.Protobuf.ListValue.Builder {
        let jsonData = try NSJSONSerialization.jsonObject(with: data, options: NSJSONReadingOptions(rawValue: 0))
        guard let jsDataCast = jsonData as? Dictionary<String,AnyObject> else {
          throw ProtocolBuffersError.invalidProtocolBuffer("Invalid JSON data")
        }
