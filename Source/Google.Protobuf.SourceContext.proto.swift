...
public extension Google.Protobuf {
  ...
  final public class SourceContext : GeneratedMessage, GeneratedMessageProtocol {
    ...
    public class func parseArrayDelimitedFromInputStream(_ input:NSInputStream) throws -> Array<Google.Protobuf.SourceContext> {
    ...
    public class func parseFromDelimitedFromInputStream(_ input:NSInputStream) throws -> Google.Protobuf.SourceContext? {
      return try Google.Protobuf.SourceContext.Builder().mergeDelimitedFromInputStream(input)?.build()
    }
    public class func parseFromData(_ data:NSData) throws -> Google.Protobuf.SourceContext {
    ...
    public class func parseFromData(_ data:NSData, extensionRegistry:ExtensionRegistry) throws -> Google.Protobuf.SourceContext {
      return try Google.Protobuf.SourceContext.Builder().mergeFromData(data, extensionRegistry:extensionRegistry).build()
    }
    public class func parseFromInputStream(_ input:NSInputStream) throws -> Google.Protobuf.SourceContext {
      return try Google.Protobuf.SourceContext.Builder().mergeFromInputStream(input).build()
    }
    public class func parseFromInputStream(_ input:NSInputStream, extensionRegistry:ExtensionRegistry) throws -> Google.Protobuf.SourceContext {
    ...
    override class public func fromJSON(_ data:NSData) throws -> Google.Protobuf.SourceContext {
    ...
    final public class Builder : GeneratedMessageBuilder {
      ...
      override class public func fromJSONToBuilder(_ data:NSData) throws -> Google.Protobuf.SourceContext.Builder {
