...
public extension Google.Protobuf {
  ...
  final public class AnyType : GeneratedMessage, GeneratedMessageProtocol {
    ...
    public class func parseArrayDelimitedFromInputStream(_ input:NSInputStream) throws -> Array<Google.Protobuf.AnyType> {
    ...
    public class func parseFromDelimitedFromInputStream(_ input:NSInputStream) throws -> Google.Protobuf.AnyType? {
      return try Google.Protobuf.AnyType.Builder().mergeDelimitedFromInputStream(input)?.build()
    }
    public class func parseFromData(_ data:NSData) throws -> Google.Protobuf.AnyType {
    ...
    public class func parseFromData(_ data:NSData, extensionRegistry:ExtensionRegistry) throws -> Google.Protobuf.AnyType {
      return try Google.Protobuf.AnyType.Builder().mergeFromData(data, extensionRegistry:extensionRegistry).build()
    }
    public class func parseFromInputStream(_ input:NSInputStream) throws -> Google.Protobuf.AnyType {
      return try Google.Protobuf.AnyType.Builder().mergeFromInputStream(input).build()
    }
    public class func parseFromInputStream(_ input:NSInputStream, extensionRegistry:ExtensionRegistry) throws -> Google.Protobuf.AnyType {
    ...
    override class public func fromJSON(_ data:NSData) throws -> Google.Protobuf.AnyType {
    ...
    final public class Builder : GeneratedMessageBuilder {
      ...
      public func setValue(_ value:NSData) -> Google.Protobuf.AnyType.Builder {
        self.value = value
        return self
      }
      ...
      override class public func fromJSONToBuilder(_ data:NSData) throws -> Google.Protobuf.AnyType.Builder {
